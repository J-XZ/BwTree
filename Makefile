...
main: $(OBJ) ./build/xz_test.o
	$(CXX) $(OBJ) -o ./main $(CXX_FLAG) $(OPT_FLAG) $(GMON_FLAG) $(LIBS)
	$(CXX) ./build/xz_test.o ./build/bwtree.o ./build/test_suite.o ./build/random_pattern_test.o ./build/basic_test.o ./build/mixed_test.o ./build/performance_test.o ./build/stress_test.o ./build/iterator_test.o ./build/misc_test.o ./build/benchmark_bwtree_full.o ./build/spinlock.o ./build/benchmark_btree_full.o ./build/benchmark_art_full.o ./build/art.o -o ./xz_test $(CXX_FLAG) $(OPT_FLAG) $(GMON_FLAG) $(LIBS)

./build/xz_test.o: ./test/xz_test.cpp
	$(CXX) ./test/xz_test.cpp -c -o ./build/xz_test.o $(CXX_FLAG) $(OPT_FLAG) $(GMON_FLAG)
